    ...
    storageLocal = [
      {
        ...
        todos: [
          ...
          {
            todo: 'Here, you can add todos or remove them!',
            dueDate: '',
            priority: 'normal',
            completed: false,
          },
          {
            todo: 'Add date information for your todos!',
            dueDate: 'August 30',
            priority: 'normal',
            completed: false,
          },
          {
            todo: 'Set your todos high priority!',
            dueDate: 'September 4',
            priority: 'high',
            completed: false,
          },
          {
            todo: 'Toggle your todos completed!',
            dueDate: 'October 6',
            priority: 'high',
            completed: true,
          },
      ...
      { name: 'Project 2', todos: [] },
      { name: 'Project 3', todos: [] },
    ];
  }
  if (storageLocal != null) {
    if (storageLocal != [] && storage.length == 0) {
      ...
      for (let j = 0; j < storage.length; j++) {
        ...
        storage[j][addTodoMethod] = function(todo) {
        ...
        for (let x = 0; x < storage[j].todos.length; x++) {
          ...
          storage[j].todos[x][togglePriMethod] = function() {
            this.priority =
              this.priority == 'normal' ? 'high' : 'normal';
          };
        }
      }
