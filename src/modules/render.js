...
import { addTodo,addProject, todoFormListener } from './handlers.js'
...
const renderRemoveProject = (obj, storage) => {
  ...
  deletePrjButton.classList.add('fas', 'fa-minus-circle', 'red', 'left');
...
export {renderProject,renderTButton, renderTodos, renderAddTodo, renderAddProject};
